...
public class NewDrawIntegrationTest {
  @MockBean
...
@Test
public void checkNewDrawIsDspd(){
  ...
  chromeDriver.get(url);
    ...
    assertAll("Comprobar que se muestra el contenido de la creacion de usuario en el apartado de formulario",
...
@Test
  ...
  public void checkClickHome(){
    String url="http://localhost:" + port + "/";
      chromeDriver.get(url);
      chromeDriver.findElement(By.id("to-home-link")).click();
      String actualTitle = chromeDriver.getTitle();
